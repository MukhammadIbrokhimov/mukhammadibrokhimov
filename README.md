...
- **Core Curriculum, Computer Software Engineering**  
  42 Berlin  
  **September 2024 - Present**  
  At 42 Berlin, I am engaged in an intensive program covering both fundamental and advanced software development topics. The curriculum builds programming skills in C and C++, delves into UNIX processes, network architecture, and system administration, and emphasizes teamwork, collaboration, and self-directed learning.  
  - Key Skills and Projects:
    ...
    - **Graphics and Web Programming**

- **B.Sc. Software Engineering**  
  University of Europe  
  **March 2023 - May 2026** (Berlin, Germany)

- **B.Sc. Data Science, AI, and Digital Business**  
  University of GISMA  
  **March 2023 - May 2026** (Potsdam, Germany)

- **BA(Hons) Business Management Foundation**  
  University of Law  
  **January 2021 - December 2021** (Guildford, England)
...
- **Back End Developer (Contract)**  
  DigitalDaily - [digitaldaily.de](https://digitaldaily.de)  
  **October 2024 - Present** (Remote, Berlin, Germany)  
  - Developed and integrated APIs to retrieve climate data from external sources.
  - Implemented AI algorithms to analyze climate data and generate actionable insights.
  - Utilized Large Language Models (LLMs) to create content based on climate data analysis.
  - Collaborated on content management within WordPress using Python scripts.
  - Ensured seamless data flow between APIs, AI systems, and content management platforms.

- **Software Engineer (Intern to Junior) (Remote)**  
  Stay Fit E Commerce - StayFit.uz  
  **March 2024 - Present**  
  - Designed and maintained backend functionalities using Python and Django.
  - Integrated frontend components with backend services for smooth user experiences.
  - Implemented Git version control, enhancing team collaboration by 20%.

- **Full Stack Python Developer (Django 3)**  
  Mohirdev - mohirdev.uz  
  **January 2023 - September 2023**  
  - Developed efficient searching algorithms, optimized data structures, and enhanced data retrieval processes.

- **Junior Web Programmer**  
  Self-Study  
  **February 2022 - December 2023**  
  - Built dynamic web applications with Python and MySQL, focusing on end-to-end development.
